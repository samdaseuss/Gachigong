# 가치공(Gachigong)
#가치공, # 같이공부하자, # 공부에 가치를 더하다
```
“공부에 가치를 더하다”, “같이 공부하다.” 라는 중의적인 뜻을 담고있는 웹 어플리케이션으로
2023년 11월 22일 개발을 시작해 12월 4일 1차 개발을 완료한 스프링부트 프레임워크를 사용한
팀 프로젝트입니다.
```
(이미지)
...
[2. 디자인 시안](#디자인-시안-와이어-프레임)

[3. 데이터 모델 다이어그램(ERD)](#데이터-모델-다이어그램-erd)

[4. 개발 환경 및 기술 스택](#개발-환경-및-기술스택)
- [4.1. 개발 환경](#개발-환경)
- [4.2. 기술 스택](#기술-스택)

[5. 상세 페이지 및 기능 설명](#상세-페이지-설명)
- [5.1. 메인 페이지](#1-메인-페이지--홈-화면-)
- [5.2. 캘린더 및 계획 등록 페이지](#2-캘린더-및-계획-등록-페이지)
- [5.3. 스터디그룹 랭킹 페이지](#3-스터디-그룹-랭킹-페이지)
- [5.4. 스터디그룹 상세 페이지](#4-스터디-그룹-상세-페이지)
- [5.5. 로그인 & 회원가입](#5-로그인-및-회원가입-페이지)
...
## 요구사항
### 1차 요구사항
* 권한이 있는 사용자만 서비스 이용 가능 (by 로그인, 회원가입)
* 메인 화면에서 사용자에게 디데이 정보를 보여준다.

### 2차 요구사항
* 권한이 있는 사용자만 서비스 이용 가능 (스프링 시큐리티 적용)
* 관리자 계정 권한 새로 생성
* 관리자는 대쉬보드를 통해 사용자를 관리할 수 있다. ( 해당그룹 가입여부 확인, 그룹 탈퇴처리 등 )
* 관리자여도 사용자의 개인적인 일정은 볼 수 없다.( 캘린더 개인 일정, 오늘의 할일 )

## 디자인 시안 (와이어 프레임)
위의 요구사항에 맞춰 와이어프레임과 디자인 시안을 작성하였습니다.
...
## 브랜치 전략
협업을 위해 저희 조는 다음과 같은 브랜치 전략을 사용하였습니다.
